...
const StudentRegistration = () => {
    ...
    const handleRegister = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await axios.post('https://www.sr.apnipaathshaala.in/api/v1/student/Create-Student', formData);
    ...
    const resendOtp = async () => {
        try {
            const response = await axios.post('https://www.sr.apnipaathshaala.in/api/v1/student/resent-otp', { Email: verifyData.Email });
            toast.success(response.data.message);
        } catch (error) {
            console.log(error)
            toast.error(error.response?.data?.message || "An error occurred");
    ...
    const verifyOtp = async () => {
        try {
            const response = await axios.post('https://www.sr.apnipaathshaala.in/api/v1/student/Verify-Student', verifyData);
