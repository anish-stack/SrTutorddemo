...
const AllCitys = () => {
    ...
    const createCity = async () => {
        ...
        setLoading(true)
        try {
            const response = await axios.post('http://localhost:7000/api/v1/admin/Create-City', data, {
                headers: {
    ...
    const deleteCity = async () => {
        ...
        setLoading(true)
        try {
            await axios.delete(`http://localhost:7000/api/v1/admin/delete-City/${selectedCity._id}`);
            fetchData();
    ...
    const updateCity = async () => {
        ...
        setLoading(true)
        try {
            await axios.put(`http://localhost:7000/api/v1/admin/update-City/${selectedCity._id}`, data, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
            });
