...
const AllStudents = () => {
    ...
    useEffect(() => {
        const fetchStudents = async () => {
            try {
                const response = await axios.get('https://sr.apnipaathshaala.in/api/v1/student/get-all-students', {
                    headers: {
    ...
    const handleDeleteStudent = async (studentId) => {
        try {
            await toast.promise(
                axios.delete(`https://sr.apnipaathshaala.in/api/v1/student/studentDelete/${studentId}`, {
                    headers: {
                        Authorization: `Bearer ${Token}`
                    }
                }),
