...
const AllSubscription = () => {
    ...
    const handleFetch = async () => {
        try {
            const res = await axios.get('https://sr.apnipaathshaala.in/api/v1/admin/get-all-subscribe-newsletter-email');
    ...
    const handleDelete = async () => {
        try {
            await axios.delete(`https://sr.apnipaathshaala.in/api/v1/admin/delete-newsletter-email/${selectedEmailId}`);
            handleFetch();
