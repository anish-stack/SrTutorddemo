...
const ClassTeacherRequest = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await axios.get('http://localhost:7000/api/v1/student/Class-Teacher-Request');
    ...
    const fetchComments = async (id) => {
        console.log(id)
        try {
            const response = await axios.get(`http://localhost:7000/api/v1/student/Class-Get-Comments/${id}`);
    ...
    const handleDelete = async (id) => {
        if (window.confirm('Are you sure you want to delete this request?')) {
            try {
                await axios.delete(`http://localhost:7000/api/v1/student/Class-Delete-Request/${id}`);
    ...
    const handleUpdate = async (id, status) => {
        try {
            await axios.post(`http://localhost:7000/api/v1/student/Class-Accept-Request/${id}/${status}`);
    ...
    const handleAddComment = async (comment) => {
        ...
        setCommentError('');
        try {
            await axios.post(`http://localhost:7000/api/v1/student/Class-comment-Request`, {
